// Package table define all table _type methods.
// base.go contains basic methods of table _type.
package table
...
// tableType: Use to record table _type
...
// Type method returns a table _type string.
...
// IsSimpleTable method returns a bool value indicate the table _type is simpleTableType.
func (b *base) IsSimpleTable() bool {
	return b.tableType == simpleTableType
}

// IsSafeTable method returns a bool value indicate the table _type is safeTableType.
