...
//
// The TL;DR is that you make a .env.sample file that looks something like
//
...
//
// If you call Load without any args it will default to loading .env.sample in the current path.
//
...
// Call this function as close as possible to the start of your program (ideally in main).
//
// If you call Overload without any args it will default to loading .env.sample in the current path.
//
// You can otherwise tell it which files to load (there can be more than one) like:
//
